  ...
  <div class="sc-message">
    <div class="sc-message--content" :class="{
      ...
      <slot
        ...
        :message="message"
        :user="message.user">
          <div v-if="message.type !== 'system' && message.user" :title="authorName" class="sc-message--avatar" :style="{
            backgroundImage: `url(https://eu.ui-avatars.com/api/?name=${message.user.id}&background=0D8ABC&color=fff&size=35)`
